...
(function () {
    document.getElementById('run').addEventListener('click', function (e) {
        ...
        var mail = people.filter(person => person.firstname === 'Jean' && person.lastname === 'Dupont')[0].email
        console.log(mail)

        var ind = people.findIndex(person => person.firstname === 'Jean' && person.lastname === 'Dupont');
        console.log(ind);
